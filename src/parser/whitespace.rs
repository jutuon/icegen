...
fn line_comment(input: &str) -> IResult<&str, &str> {
    delimited(tag(LINE_COMMENT_START), take_until(LINE_COMMENT_END), tag(LINE_COMMENT_END))(input)
}

fn multi_line_comment(input: &str) -> IResult<&str, &str> {
    delimited(tag(MULTI_LINE_COMMENT_START), take_until(MULTI_LINE_COMMENT_END), tag(MULTI_LINE_COMMENT_END))(input)
}
